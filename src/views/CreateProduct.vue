  ...
  <div class="container mt-5">
    ...
    <form class="text-bg-dark p-4 mt-5 rounded" @submit.prevent="createProduct()">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="description" id="" cols="30" rows="3" placeholder="Product description"
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="currency" id="currency" v-model="currency" required>
          <option>ZAR</option>
          <option>NGN</option>
          <option>GHS</option>
          <option>USD</option>
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="unlimited" id="unlimited" v-model="unlimited" required>
          <option>false</option>
          <option>true</option>
        </select>
      </div>
      <div class="form-group">
        ...
        <input class="form-control" type="number" placeholder="Product Quantity" v-model="quantity" required />
      </div>
